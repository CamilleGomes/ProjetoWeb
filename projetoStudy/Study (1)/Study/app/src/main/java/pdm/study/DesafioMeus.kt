...
fun DesafioMeu(activity: ComponentActivity) {
    Column(
        ...
        Spacer(modifier = Modifier.size(1.dp))
        Text(
            text = "Desafio de revisão de matemática",
            style = TextStyle(
                fontSize = 20.sp
            ),
            modifier = Modifier
        ...
        Box(
            ...
            val text = buildAnnotatedString {
                ...
                append("Rever e consolidar o conhecimento em uma matéria específica")
            }
            Text(
                text = text,
                fontSize = 16.sp,
        ...
        Box(
            ...
            val text = buildAnnotatedString {
                ...
                append("Todos os participantes escolhem uma matéria (por exemplo matemática, história) e se comprometem a revisa-la regularmente")
            }
